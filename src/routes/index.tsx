      ...
      <section className="relative min-h-[100svh] flex flex-col justify-end text-white overflow-hidden">
        ...
        <div className="container-page pb-16 pt-32 sm:pt-40 md:pb-24">
          <div className="max-w-4xl reveal">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col md:flex-row gap-6 md:gap-12 md:items-end max-w-3xl">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 w-full sm:w-auto">
                <Link
                  to="/contact"
                  className="inline-flex justify-center items-center bg-accent text-accent-foreground px-7 py-4 text-[11px] font-semibold uppercase tracking-[0.2em] hover:bg-background hover:text-ink transition-colors w-full sm:w-auto text-center"
                >
                  Get a Free Quote
                </Link>
                <Link
                  to="/projects"
                  className="inline-flex justify-center items-center border border-white/40 text-white px-7 py-4 text-[11px] font-semibold uppercase tracking-[0.2em] hover:bg-white/10 transition-colors w-full sm:w-auto text-center"
                >
                  View Projects
                </Link>
              </div>
