  ...
  return (
    <>
      ...
      <section className="pb-16 sm:pb-24">
        <div className="container-page">
          <Link to="/journal" className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-10 border-b border-line pb-10 sm:pb-16 hover-image group">
            ...
            <div className="md:col-span-5 flex flex-col justify-end">
              ...
              <h2 className="mt-3 sm:mt-4 font-display text-2xl sm:text-3xl md:text-4xl tracking-tightest text-ink leading-tight">
                {feature.title}
              </h2>
              <p className="mt-4 sm:mt-6 text-sm sm:text-base text-muted-foreground leading-relaxed">{feature.excerpt}</p>
              <div className="mt-4 sm:mt-6 eyebrow text-ink">{feature.read} read →</div>
            </div>
          </Link>
        </div>
      </section>
      ...
      <section className="pb-24 sm:pb-32">
        <div className="container-page grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-14">
          {rest.map((p) => (
            <Link key={p.slug} to="/journal" className="group hover-image">
              ...
              <div className="mt-4 sm:mt-5 eyebrow text-accent">{p.tag} · {p.date}</div>
              <h3 className="mt-2 sm:mt-3 font-display text-xl sm:text-2xl tracking-tighter text-ink">{p.title}</h3>
              <p className="mt-2 sm:mt-3 text-sm sm:text-base text-muted-foreground leading-relaxed">{p.excerpt}</p>
              <div className="mt-3 sm:mt-4 eyebrow text-ink">{p.read} read →</div>
            </Link>
          ))}
        </div>
      </section>
